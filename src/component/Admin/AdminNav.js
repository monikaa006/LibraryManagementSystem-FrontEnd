            ...
            <div className="navbar-collapse collapse" id="collapsingNavbar">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="https://ndl.iitkgp.ac.in/">Link</a>
                    </li>
                </ul>
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="/About" data-target="#myModal" data-toggle="modal">About</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link waves-effect waves-light text-white" href='/'>
                            <i className="fab fa-google-plus-g"></i>
                        </a>
                    </li>
                    <li className="nav-item">
                        <a href='/' className="nav-link waves-effect waves-light text-white">
