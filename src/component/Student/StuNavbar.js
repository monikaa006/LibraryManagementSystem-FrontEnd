                ...
                <div className="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className="nav-item active ms-2">
                            <NavLink className="nav-link" exact to="/StudentHome">Home </NavLink>
                        </li>
                        ...
                        {removeUser ? 
                        <li className="nav-item">
                            <button className="btn btn-default" onClick={logOut}  style={{ color: "white", marginLeft: "800px"  }} >logOut</button>
                        </li> : 
                       <>
                 <li className="nav-item">
